...
export const metadata: Metadata = {
  ...
  description: "Search and verify certifications for GreenFreightAcademy-trained drivers. This registry is publicly accessible to prospective employers, fleet operators, and compliance auditors.",
};
      ...
      >
        <div className="container-gfa">
          ...
          <h1 style={{ maxWidth: "600px", marginBottom: "1rem" }}>
            Publicly searchable registry of certified drivers
          </h1>
          <p style={{ maxWidth: "520px", color: "var(--text-secondary)" }}>
            Search and verify certifications for GreenFreightAcademy-trained drivers. This registry is publicly accessible to prospective employers, fleet operators, and compliance auditors.
          </p>
        </div>
      </section>
