/**
 * GreenFreightAcademy — Register your company
 *
 * DATA REQUIREMENTS:
...
export const metadata: Metadata = {
  ...
  description: "Register your company to access the GFA dashboard, import employees, and enrol your team in training programmes.",
};
      ...
      >
        <div className="container-gfa">
          ...
          <p style={{ maxWidth: "520px", color: "var(--text-secondary)" }}>
            Register your company to access the GFA dashboard, import employees, and enrol your team in training programmes.
          </p>
        </div>
      </section>
