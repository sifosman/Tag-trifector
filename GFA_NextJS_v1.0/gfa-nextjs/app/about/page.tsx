...
export const metadata: Metadata = {
  ...
  description: "GreenFreightAcademy builds skills and capability across every level of the road freight enterprise — from professional drivers and eco-drivers through to managers, procurement teams, and transition leaders.",
};
      ...
      >
        <div className="container-gfa">
          ...
          <h1 style={{ maxWidth: "600px", marginBottom: "1rem" }}>
            The enterprise capability and performance engine for road freight
          </h1>
          <p style={{ maxWidth: "520px", color: "var(--text-secondary)" }}>
            GreenFreightAcademy builds skills and capability across every level of the road freight enterprise — from professional drivers and eco-drivers through to managers, procurement teams, and transition leaders.
          </p>
        </div>
      </section>
